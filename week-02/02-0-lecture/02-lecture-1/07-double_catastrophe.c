/*
Demonstrate approximate representation of reals producing error. sometimes if we
subtract two approximations which are very close together we can can get a large
relative error 
